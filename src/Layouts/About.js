...
function About({ uiState, setUiState }) {
  ...
  let answerTwo =
    "This project was created by Jatin Arora. A Computer Applications student, developer, and designer who likes creating awesome things that live on the internet! If you like what you just saw and would like to see more, then scroll below to check his socials!";
      ...
      <div className="about__wrapper">
        ...
        <div className="about-socials">
          <div className="about-socials-group">
            ...
            <p className="about-socials-text">@jatin___arora__</p>
          </div>
          <div className="about-socials-group">
            <RiLinkedinBoxFill className="about-socials-icon" />
            <p className="about-socials-text">/in/jatin-arora-674a311b5/</p>
          </div>
          <div className="about-socials-group">
            <RiMailLine className="about-socials-icon" />
            <p className="about-socials-text">jatinaroraaaa3@gmail.com</p>
          </div>
        </div>
